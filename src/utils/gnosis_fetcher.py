...
SUBGRAPH_ENDPOINTS = {
    "gnosis": "https://api.thegraph.com/subgraphs/name/sushiswap/xdai-minichef",
}
...
"""
    ...
    if response.status_code == 200:
        ...
        # convert to csv
        with open("gnosis_pids.csv", "w", newline="") as csv_file:
        ...
        # convert to df
        df = pd.read_csv("gnosis_pids.csv")
        ...
        print("\nData pulled from Gnosis and ported successfully")
